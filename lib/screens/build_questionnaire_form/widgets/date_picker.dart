...
class TextfieldDatePicker extends StatefulWidget {
  ...
  /// For more info. on DateFormat visit -- http://api.flutter.dev/flutter/intl/DateFormat-class.html
  ///
  final intl.DateFormat preferredDateFormat;

  ///The [materialDatePickerBuilder] parameter can be used to wrap the dialog widget to add inherited widgets like Theme.(for more info. on applying theme visit -- http://api.flutter.dev/flutter/material/Theme-class.html)
  ///
  final Widget Function(BuildContext, Widget?)? materialDatePickerBuilder;

  ///[materialDatePickerLocale] optional locale argument can be used to set the locale for the date picker. It defaults to the ambient locale provided by Localizations. visit -- http://api.flutter.dev/flutter/widgets/Localizations-class.html for more info. on localization
  ///
          ...
          DatePicker()
            ...
            if (value == null) {
              ...
              setState(() {
                ...
                value == null ? "" : value;
                 widget.onSaved(widget.textfieldDatePickerController.text ?? '');
              });
            }
