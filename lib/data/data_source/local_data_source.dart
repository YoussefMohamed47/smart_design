...
abstract class LocalDataSource {
  Future getData(String key, int time);

  Future<void> saveToCache(dynamic homeResponse, String key);
...
class LocalDataSourceImpl implements LocalDataSource {
  ...
  @override
  Future getData(String key, int time) async {
    CachedItem? cachedItem = cacheMap[key];
    print("cachedItem != null ${cachedItem != null}");
    if (cachedItem != null && cachedItem.isValid(time)) {
  ...
  @override
  Future<void> saveToCache(dynamic homeResponse, String key) async {
    cacheMap[key] = CachedItem(homeResponse);
  }
